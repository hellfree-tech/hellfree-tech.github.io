                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                      ...
                      <!--  <li class="nav-item ms-3">
                            <a class="nav-link custom-btn custom-border-btn custom-btn-bg-white btn" href="contact.php">Get started</a>
                        </li> -->
                    </ul>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12 me-auto mb-lg-0 mb-5">
                            ...
                            <p>Hellfree is ready to serve you. To make sure you are sailing easily into the digital world.</p>
                        ...
                        <div class="col-lg-6 col-12">
                            <form class="custom-form consulting-form bg-white shadow-lg mb-5 mb-lg-0" action="free_quotation.php" method="post" role="form">
                                ...
                                <div class="consulting-form-body">
                                    ...
                                    <div class="col-lg-6 col-md-10 col-8 mx-auto">
                                        <button type="submit" class="form-control" value="send">Submit Request</button>
                                    </div>
                                </div>
                            </form>
                        </div>
